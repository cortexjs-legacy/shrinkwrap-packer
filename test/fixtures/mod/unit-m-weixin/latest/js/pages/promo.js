define("unit-m-weixin@latest/js/modules/promo/content/controller", ["marionette@~1.4.0","./view","backbone@~1.1.0","underscore@~1.5.0"], function(require, exports, module) {
...
define("unit-m-weixin@latest/js/modules/promo/layout.html", [], function(require, exports, module) {
...
define("unit-m-weixin@latest/js/modules/promo/content/view", ["marionette@~1.4.0","backbone@~1.1.0","underscore@~1.5.0","zepto-wepp@~1.1.0","cookie@~0.1.0","wepp@~2.7.0","./template.html"], function(require, exports, module) {
var Marionette = require('marionette');
var Backbone = require('backbone');
var Router = new Backbone.Router();
var _ = require('underscore');
...
define("unit-m-weixin@latest/js/modules/promo/content/template.html", [], function(require, exports, module) {
...
define("unit-m-weixin@latest/js/pages/promo", ["zepto-wepp@~1.1.0","underscore@~1.5.0","marionette@~1.4.0","../modules/promo/content/controller","../modules/promo/layout.html"], function(require, exports, module) {
var $ = require('zepto-wepp');
var _ = require('underscore');
var Marionette = require('marionette');
