define("unit-m-weixin@latest/js/modules/refund/button/template.html", [], function(require, exports, module) {
...
define("unit-m-weixin@latest/js/base/share", ["wepp@~2.7.0","underscore@~1.5.0","zepto-wepp@~1.1.0"], function(require, exports, module) {
...
define("unit-m-weixin@latest/js/modules/common/footmenu/controller", ["marionette@~1.4.0","wepp@~2.7.0","./template.html","zepto-wepp@~1.1.0","../overlay","underscore@~1.5.0"], function(require, exports, module) {
...
define("unit-m-weixin@latest/js/util/geolocation", ["backbone@~1.1.0","zepto-wepp@~1.1.0","underscore@~1.5.0","cookie@~0.1.0"], function(require, exports, module) {
...
define("unit-m-weixin@latest/js/modules/common/first", ["wepp@~2.7.0"], function(require, exports, module) {
/*
 * 检验用户是否是第一次
 *
 * 第一次进入去选择城市页面
...
define("unit-m-weixin@latest/js/modules/refund/layout.html", [], function(require, exports, module) {
...
define("unit-m-weixin@latest/js/config/routeconfig", [], function(require, exports, module) {
var listShareConfig = {
    title:'点评团·放心团',
...
define("unit-m-weixin@latest/js/config/envconfig", ["wepp@~2.7.0"], function(require, exports, module) {
...
define("unit-m-weixin@latest/js/modules/common/overlay", ["zepto-wepp@~1.1.0","underscore@~1.5.0","backbone@~1.1.0"], function(require, exports, module) {
var $ = require('zepto-wepp');
var _ = require('underscore');
var Backbone = require('backbone');
...
define("unit-m-weixin@latest/js/filters/login", ["zepto-wepp@~1.1.0","wepp@~2.7.0"], function(require, exports, module) {
var $ = require('zepto-wepp');
var ENV = require('wepp').ENV;
...
define("unit-m-weixin@latest/js/modules/refund/content/view", ["marionette@~1.4.0","underscore@~1.5.0","zepto-wepp@~1.1.0","./template.html"], function(require, exports, module) {
var Marionette  = require('marionette');
var _ = require('underscore');
var $ = require('zepto-wepp');
...
define("unit-m-weixin@latest/js/modules/common/alert/controller", ["wepp@~2.7.0","./template.html","backbone@~1.1.0","marionette@~1.4.0","underscore@~1.5.0","zepto-wepp@~1.1.0"], function(require, exports, module) {
var View = require('wepp').Module.BaseView(require('./template.html'));
var Backbone = require('backbone');
var Marionette = require('marionette');
var _ = require('underscore');
...
define("unit-m-weixin@latest/js/modules/refund/cause/view", ["marionette@~1.4.0","underscore@~1.5.0","zepto-wepp@~1.1.0","./template.html"], function(require, exports, module) {
var Marionette  = require('marionette');
var _ = require('underscore');
var $ = require('zepto-wepp');
...
define("unit-m-weixin@latest/js/util/cache", [], function(require, exports, module) {
var hash = {};
...
define("unit-m-weixin@latest/js/modules/refund/button/view", ["marionette@~1.4.0","underscore@~1.5.0","zepto-wepp@~1.1.0","wepp@~2.7.0","./template.html"], function(require, exports, module) {
var Marionette  = require('marionette');
var _ = require('underscore');
var $ = require('zepto-wepp');
...
define("unit-m-weixin@latest/js/modules/refund/button/controller", ["marionette@~1.4.0","./view","underscore@~1.5.0"], function(require, exports, module) {
var Marionette = require('marionette');
...
define("unit-m-weixin@latest/js/modules/common/alert/template.html", [], function(require, exports, module) {
...
define("unit-m-weixin@latest/js/modules/refund/cause/controller", ["marionette@~1.4.0","./view","underscore@~1.5.0"], function(require, exports, module) {
var Marionette = require('marionette');
var View = require("./view"),
    _ = require('underscore');
...
define("unit-m-weixin@latest/js/modules/common/footmenu/template.html", [], function(require, exports, module) {
...
define("unit-m-weixin@latest/js/modules/refund/content/controller", ["marionette@~1.4.0","./view","underscore@~1.5.0"], function(require, exports, module) {
var Marionette = require('marionette');
var View = require("./view"),
    _ = require('underscore');
...
define("unit-m-weixin@latest/js/modules/refund/content/template.html", [], function(require, exports, module) {
...
define("unit-m-weixin@latest/js/entities/refund", ["backbone@~1.1.0"], function(require, exports, module) {
var Backbone = require('backbone');
...
define("unit-m-weixin@latest/js/modules/refund/cause/template.html", [], function(require, exports, module) {
...
define("unit-m-weixin@latest/js/app", ["wepp@~2.7.0","./base/share","./modules/common/footmenu/controller","./util/geolocation","./util/cache","zepto-wepp@~1.1.0","./modules/common/first","./config/deviceconfig","./config/routeconfig","./config/envconfig","./modules/common/overlay","hippo@~1.2.0","./filters/login"], function(require, exports, module) {
...
define("unit-m-weixin@latest/js/config/deviceconfig", [], function(require, exports, module) {
module.exports = {
    "iphone4":{
        pageLength:4
    },
...
define("unit-m-weixin@latest/js/pages/refund", ["zepto-wepp@~1.1.0","underscore@~1.5.0","wepp@~2.7.0","../app","../entities/refund","../modules/refund/content/controller","../modules/refund/cause/controller","../modules/refund/button/controller","../util/cache","../modules/common/alert/controller","../modules/refund/layout.html"], function(require, exports, module) {
var $ = require('zepto-wepp');
var _ = require('underscore');
var Wepp = require('wepp');
var App = require('../app');
