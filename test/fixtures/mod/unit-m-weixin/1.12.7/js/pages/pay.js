...
define("unit-m-weixin@1.12.7/js/modules/pay/layout.html", [], function(require, exports, module) {
...
define("unit-m-weixin@1.12.7/js/entities/detail", ["backbone@~1.1.0","../base/weixin","wepp@~2.7.0","./dealstatus"], function(require, exports, module) {
...
define("unit-m-weixin@1.12.7/js/modules/pay/dealinfo/template.html", [], function(require, exports, module) {
...
define("unit-m-weixin@1.12.7/js/modules/pay/delivery/controller", ["wepp@~2.7.0","../../../entities/delivery","../../../util/cache","./template.html"], function(require, exports, module) {
/*
 *  配送地址模块
 * */
...
define("unit-m-weixin@1.12.7/js/modules/pay/mobile/template.html", [], function(require, exports, module) {
...
define("unit-m-weixin@1.12.7/js/entities/payment", ["wepp@~2.7.0","zepto-wepp@~1.1.0","backbone@~1.1.0"], function(require, exports, module) {
/*
 * 获取支付信息的接口
 *
 * */
...
define("unit-m-weixin@1.12.7/js/modules/pay/payment/template.html", [], function(require, exports, module) {
...
define("unit-m-weixin@1.12.7/js/modules/pay/submit/template.html", [], function(require, exports, module) {
...
define("unit-m-weixin@1.12.7/js/modules/pay/submit/controller", ["wepp@~2.7.0","../../../util/ajax","backbone@~1.1.0","./template.html","../../common/alert/controller"], function(require, exports, module) {
var Wepp = require('wepp');
...
define("unit-m-weixin@1.12.7/js/entities/delivery", ["backbone@~1.1.0","underscore@~1.5.0"], function(require, exports, module) {
/*
 * 新支付页面地址model
* */
var Backbone = require('backbone');
...
define("unit-m-weixin@1.12.7/js/modules/pay/payment/controller", ["wepp@~2.7.0","../../../entities/payment","../../../util/cache","./template.html"], function(require, exports, module) {
var Wepp = require('wepp');
...
define("unit-m-weixin@1.12.7/js/modules/pay/delivery/template.html", [], function(require, exports, module) {
...
define("unit-m-weixin@1.12.7/js/modules/pay/mobile/controller", ["underscore@~1.5.0","wepp@~2.7.0","zepto-wepp@~1.1.0","backbone@~1.1.0","cookie@~0.1.0","../../../util/ajax","./template.html"], function(require, exports, module) {
/*
 * 支付页面手机号模块
 * 不光是手机，用户登录相关的都在这里
 *
...
define("unit-m-weixin@1.12.7/js/base/weixin", [], function(require, exports, module) {
...
define("unit-m-weixin@1.12.7/js/modules/pay/dealinfo/controller", ["wepp@~2.7.0","../../../util/cache","backbone@~1.1.0","../../../entities/detail","./template.html"], function(require, exports, module) {
var Wepp = require('wepp');
var Cache = require('../../../util/cache');
var Backbone = require('backbone');
...
define("unit-m-weixin@1.12.7/js/util/ajax", ["wepp@~2.7.0","zepto-wepp@~1.1.0","underscore@~1.5.0"], function(require, exports, module) {
/*
 * 封装下$.ajax
 * 根据code处理
 * 用POST
...
define("unit-m-weixin@1.12.7/js/pages/pay", ["zepto-wepp@~1.1.0","underscore@~1.5.0","wepp@~2.7.0","../util/cache","../modules/pay/dealinfo/controller","../modules/pay/mobile/controller","../modules/pay/payment/controller","../modules/pay/submit/controller","../modules/pay/delivery/controller","../modules/pay/layout.html"], function(require, exports, module) {
var $ = require('zepto-wepp');
var _ = require('underscore');
var Wepp = require('wepp');
var Cache = require('../util/cache');
