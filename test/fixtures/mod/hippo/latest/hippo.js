define("hippo@latest/hippo2", [], function(require, exports, module) {
'use strict';
...
function send(key, value, data) {
  ...
  if (!/\.dianping\.com/.test(location.domain)) {
    base = 'http://hls.51ping.com' + base;
  } else {
    base = 'http://hls.dianping.com' + base;
  }

  var query = generateQuery(key, value, data);
  var image = new Image(1, 1);
  queue.push(image);
  image.src = base + query;
  registerClean(image);
}
